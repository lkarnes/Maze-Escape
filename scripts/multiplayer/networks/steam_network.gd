...
func become_host():
	...
	multiplayer_peer.create_lobby(Steam.LOBBY_TYPE_PUBLIC, SteamManager.lobby_max_members)
...
func list_lobbies():
	...
	Steam.addRequestLobbyListStringFilter("name", "Maze Tank", Steam.LOBBY_COMPARISON_EQUAL)
