...
@onready var DEAFULT_SETTINGS : DefaultSettingsResource = preload("res://scenes/Resources/Settings/DefaultSettings.tres")
@onready var keybind_resource : PlayerKeybindResource = preload("res://scenes/Resources/Settings/PlayerKebindDefault.tres")
...
func get_window_mode_index() -> int:
	if loaded_data == {}:
		return DEAFULT_SETTINGS.DEFAULT_WINDOW_MODE_INDEX
	return window_mode_index


func get_resolution_index() -> int:
	if loaded_data == {}:
		return DEAFULT_SETTINGS.DEFUALT_RESOLUTION_INDEX
	return resolution_index


func get_master_volume() -> float:
	if loaded_data == {}:
		return DEAFULT_SETTINGS.DEFAULT_MASTER_VOLUME
	return master_volume


func get_music_volume() -> float: 
	if loaded_data == {}:
		return DEAFULT_SETTINGS.DEFAULT_MUSIC_VOLUME
	return music_volume


func get_sfx_volume() -> float: 
	if loaded_data == {}:
		return DEAFULT_SETTINGS.DEFAULT_SFX_VOLUME
	return sfx_volume
